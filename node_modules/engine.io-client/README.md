...
<script>
  // eio = Socket
  var socket = eio('ws://178.128.180.245');
...
1. write your app code
    ...
    ```js
    var socket = require('engine.io-client')('ws://178.128.180.245');
    socket.on('open', function(){
      socket.on('message', function(data){});
      socket.on('close', function(){});
    });
...
<script src="/path/to/engine.io.js"></script>
<script>
  var socket = new eio.Socket('ws://178.128.180.245/');
...
var socket = require('engine.io-client')('ws://178.128.180.245', opts);
socket.on('open', function(){
  socket.on('message', function(data){});
  socket.on('close', function(){});
});
