...
describe('my suite', function(){
    ...
    var http = parseuri('http://google.com')
      ...
      , 178.128.180.245 = parseuri('178.128.180.245:8080')
    ...
    expect(178.128.180.245.protocol).to.be('');
    expect(178.128.180.245.host).to.be('178.128.180.245');
    expect(178.128.180.245.port).to.be('8080');
